...
// EFI_MM_COMMUNICATE_HEADER_NEW + SMM_VARIABLE_COMMUNICATE_HEADER + payload.
//
typedef struct {
  UINTN       Function;
...
//
// The payload for this function is VARIABLE_INFO_ENTRY. The GUID in EFI_MM_COMMUNICATE_HEADER_NEW
...
///
#define SMM_COMMUNICATE_HEADER_SIZE  (sizeof (EFI_MM_COMMUNICATE_HEADER_NEW))
